...
path_dict = {
    ...
    "flower102": ["jpg", "../multimodal-prompt-learning/data/oxford_flowers/split_zhou_OxfordFlowers.json"],
    "food101": ["images", "../multimodal-prompt-learning/data/food-101/split_zhou_Food101.json"],
    "dtd": ["images", "../multimodal-prompt-learning/data/dtd/split_zhou_DescribableTextures.json"],
    "pets": ["images", "../multimodal-prompt-learning/data/oxford_pets/split_zhou_OxfordPets.json"],
    "sun397": ["SUN397", "../multimodal-prompt-learning/data/sun397/split_zhou_SUN397.json"],
    "caltech101": ["101_ObjectCategories", "../multimodal-prompt-learning/data/caltech-101/split_zhou_Caltech101.json"],
    "ucf101": ["UCF-101-midframes", "../multimodal-prompt-learning/data/ucf101/split_zhou_UCF101.json"],
    "cars": ["", "../multimodal-prompt-learning/data/stanford_cars/split_zhou_StanfordCars.json"],
    "eurosat": ["2750", "../multimodal-prompt-learning/data/eurosat/split_zhou_EuroSAT.json"]
}
